...
public class MemberQuestionAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(session.getAttribute("member_id") == null || session.getAttribute("member_id").equals("")) {
			...
			System.out.println("유형"+qna.getQna_category());
			//문의권한
			...
			System.out.println("권한"+qna.getQna_author());

			qna.setQna_subject(multi.getParameter("qna_subject"));//제목
			System.out.println("제목"+qna.getQna_subject());
			...
			System.out.println("작성자"+qna.getMember_id());
			...
			if(multi.getFilesystemName("qna_file") == null || multi.getFilesystemName("qna_file").equals("")) {
				...
				System.out.println("첨부파일:"+qna.getQna_file());
			}
			...
			if(multi.getParameter("gongu_id") == null || multi.getParameter("gongu_id").equals("")) {
				...
				System.out.println("gongu_id:"+qna.getGongu_id());
			}
			...
			if(multi.getParameter("order_id")==null || multi.getParameter("order_id").equals("")) {
				...
				System.out.println("order_id:"+qna.getOrder_id());
			}
			...
			if(isRegistSuccess) {
				forward = new ActionForward("memberQnAList.qu",true);
