...
public class Qna {
	...
	public Qna(int qna_id, int qna_category, int qna_author, String qna_subject, String qna_pw, String qna_content,
	...
	public String toString() {
		return "Qna [qna_id=" + qna_id + ", qna_category=" + qna_category + ", qna_author=" + qna_author
