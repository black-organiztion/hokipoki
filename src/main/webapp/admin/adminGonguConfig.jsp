				...
				<div class="list gongu_list">
					<div class="list_header">
						<span>상태<button id="btn_help_status" class="help_icon" onclick="lyOn(this)">도움말</button>
							<div id="ly_help_status" class="ly ly_help_status p-3">
								<p>공구상태<button class="btn-close" onclick="lyOff(this)"></button></p>
								<ul style="font-size:12px;">
									<li><em>승인대기</em>공구가 최초등록된 상태입니다.</li>
									<li><em>심사중</em>관리자가 공구를 심사중입니다.</li>
									<li><em>승인</em>관리자가 승인한 공구입니다. 판매시작희망일이 되면 공구가 진행중이 됩니다.</li>
									<li><em>반려</em>관리자가 공구를 반려했습니다.</li>
									<li><em>진행중</em>진행중인 공구입니다. 구매자가 공구에 참여할 수 있습니다.</li>
									<!-- <li><em>비활성화 대기</em>관리자가 공구글을 비활성화 시키고 공구글이 비활성화 되기 전 상태, 찜하기와 참여하기가 불가능함, 공구글이 숨겨지기 전에 구매자들이 공구페이지에서 공구 중지에 대한 내용을 확인 할 수 있도록 하기 위함</li> -->
									<li><em>비활성화</em>비활성화된 공구입니다.</li>
									<li><em>정산중</em>공구마감일이 되었거나, 공구의 목표가 초과달성되어 공구의 결제가 진행중입니다.</li>
									<li><em>정산완료</em>공구 정산이 완료된 상태입니다.</li>
									<li><em>종료</em>공구가 종료되었습니다.</li>
								</ul>
							</div>
						</span>
						<span>공구명</span>
